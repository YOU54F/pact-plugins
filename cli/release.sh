...
case "$1" in
  Linux)    echo "Building for Linux"
            ...
            gzip -c target/x86_64-unknown-linux-musl/release/pact-plugin-cli > release_artifacts/pact-plugin-cli-linux-x86_64.gz
            ...
            gzip -c target/aarch64-unknown-linux-musl/release/pact-plugin-cli > release_artifacts/pact-plugin-cli-linux-aarch64.gz
  ...
  Windows)  echo  "Building for Windows"
            ...
            gzip -c target/aarch64-pc-windows-msvc/release/pact-plugin-cli.exe > release_artifacts/pact-plugin-cli-windows-aarch64.exe.gz
            openssl dgst -sha256 -r release_artifacts/pact-plugin-cli-windows-aarch64.exe.gz > release_artifacts/pact-plugin-cli-windows-aarch64.exe.gz.sha256
            ;;
